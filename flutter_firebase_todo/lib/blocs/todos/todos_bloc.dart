...
class TodosBloc extends Bloc<TodosEvent, TodosState> {
  ...
  TodosBloc({@required TodosRepository todosRepository})
    : assert(todosRepository != null), _todosRepository = todosRepository, super(TodosLoading());
  ...
  Stream<TodosState> _mapLoadTodosToState() async* {
    ...
    _todosSubscription = _todosRepository.todos().listen((todos) => add(TodosUpdated(todos)));
  }
